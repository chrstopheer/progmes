      ...
      <main className="max-w-4xl mx-auto p-4 sm:p-6 space-y-6">
        ...
        >
          <div className="flex flex-col sm:flex-row sm:items-end gap-4 sm:gap-6 justify-between">
            <div>
              <div className="text-xs uppercase tracking-widest font-semibold" style={{ color: "var(--brand-red)" }}>
                Escolha o mês
              </div>
        ...
        >
          <div className="grid grid-cols-7 gap-1 sm:gap-2 mb-2">
            {WEEKDAY_ABBR_PT.map((wd) => (
              <div key={wd} className="text-center text-[11px] sm:text-xs font-semibold uppercase tracking-wider py-2" style={{ color: "var(--brand-blue)" }}>
                {wd}
              </div>
            ))}
          </div>
              ...
              {savedMonths.map((sm) => (
                <button
                  ...
                  style={{
                    ...
                    background: sm.year === year && sm.month === month ? "var(--brand-yellow-soft)" : "white",
                  }}
                >
